...
griffon.project.dependency.resolution = {
	...
	dependencies {
		...
		compile('org.eclipse.persistence:eclipselink:2.4.0-RC2') { exclude 'javax.persistence' }
		compile('com.h2database:h2:1.3.167')
		
		//compile('org.springframework:spring-context:2.5.6')//To work with scheduling
	}
}
...
app.fileType = '.groovy'
app.defaultPackageName = 'timetracker'
